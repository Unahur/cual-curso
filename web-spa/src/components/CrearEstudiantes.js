...
handlePost(){
          ...
          if ( 
            window.confirm("Estudiante "+data.nombre_apellido+ " agregado satisfactoriamente")
      //Mensaje confirmacion, ver porque aparece dos veces pero ingresa un solo registro a la base
          ) {
